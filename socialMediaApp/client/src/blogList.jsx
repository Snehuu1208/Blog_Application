...
const BlogList = () => {
  ...
  // const fetchMoreData = () => {
  //   if (blogData.length < blogData.length + 6)
  //     setTimeout(() => {
  //       setBlogData(blogData.concat(Array.from({ length: 6 })));
  //     }, 500);
  //   else {
  //     setHasMore(false);
  //   }
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        const token = localStorage.getItem("token");
        const response = await axios.get("http://localhost:5000/blog/showAll", {
          headers: { token },
        });
      ...
      <header className=" dark:bg-gray-900 shadow-md">
        <div className="container mx-auto flex justify-between items-center p-4">
          <div className="flex">
            ...
            <div className="text-white text-5xl font-semibold mx-auto ml-4">
              Dailybiz
            </div>
          </div>
          ...
          <nav className="space-x-4 ml-auto">
            ...
            <Link to="/newPost" className="text-white hover:text-purple-500">
              Create Blog
            </Link>
            <Link to="/myBlogs" className="text-white hover:text-purple-500">
              My Blogs
            </Link>
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <div className="flex items-center">
                <img src="logo.png" className="h-8 me-3" alt="" />
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © 2023 Dailybiz . All Rights Reserved.
            </span>
